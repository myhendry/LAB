...
pub struct Request2<'a> {
	...
	// GET /search?name=abc&sort=1 HTTP/1.1
	 path: &'a str,
	 query_string: Option<QueryString2<'a>>,
	 method: Method2,
}

// getters and setters
// todo why use getters and setters?
impl<'a> Request2<'a> {
...
impl Response2 {
	...
	*/
	...
	pub fn send(&self, stream: &mut impl Write) -> IoResult<()> {
		...
		// writing to stream directly is more efficient rather than writing all to the formatter
